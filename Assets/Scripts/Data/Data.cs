...
public class Data
{
    ...
    {
        INVALID, NULL, Energy_Credits, Minerals, Food, Alloys, Consumer_Goods,
    ...
    public enum Effects
    {
        INVALID, NULL, Jobs_Energy, Jobs_Minerals, Jobs_Food, Jobs_Alloy,
    ...
    public static void loadJobs()
    {
        ...
        if (!_isCustomVersion_)
        {
            TextAsset jobsFile = Resources.Load<TextAsset>("Data/" + _version_ + "/Jobs"); // read Jobs.txt from Resource folder
            lines = jobsFile.text.Split('\n');
        }
        else
            lines = File.ReadAllLines(_customPath_ + "/Jobs.txt"); // read Jobs.txt from custom folder
    ...
    public static void loadBuildings()
    {
        ...
        if (!_isCustomVersion_)
        {
            TextAsset buildingsFile = Resources.Load<TextAsset>("Data/" + _version_ + "/Buildings");// read Buildings.txt from Resource folder
            lines = buildingsFile.text.Split('\n');
        }
        else
            lines = File.ReadAllLines(_customPath_ + "/Buildings.txt"); // read Buildings.txt from custom folder
    ...
    public static void loadDistricts()
    {
        ...
        if (!_isCustomVersion_)
        {
            ...
            lines = districtsFile.text.Split('\n');
        }
        else
            lines = File.ReadAllLines(_customPath_ + "/Districts.txt"); // read Districts.txt from custom folder
    ...
    public static void loadPlanets()
    {
        ...
        if (!_isCustomVersion_)
        {
            ...
            lines = planetsFile.text.Split('\n');
        }
        else
            lines = File.ReadAllLines(_customPath_ + "/Planets.txt"); // read Planets.txt from custom folder
    ...
    public static void loadGovernments()
    {
        ...
        if (!_isCustomVersion_)
        {
            ...
            lines = governmentFile.text.Split('\n');
        }
        else
            lines = File.ReadAllLines(_customPath_ + "/Governments.txt"); // read Governments.txt from custom folder
